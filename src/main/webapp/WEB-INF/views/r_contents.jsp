...
<body>
	...
	<div class="tab_wrap tab_area">
		...
		<div class="content_area">
				...
				<div class="table_area">
					<table class="amc1">
						...
						<tr>
							...
							<td><input type="text" name="o_num" value="${olist.o_num}" readonly>
							<c:set var="rdate" value="${olist.o_rdate}"/>
							<td class="category">수령일자&nbsp;</td>
							<td><input type="text" value="${fn:substring(rdate,0,10)} ${fn:substring(rdate,11,16)}" readonly></td>
						</tr>
						<tr>
			...
			<div class="dc_btn">
				<input id="rinsert" type="button" class="btn2" onclick="location.href='./ridingInsert?onum=${olist.o_num}'" value="배송확인">
