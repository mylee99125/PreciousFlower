...
<head>
<meta charset="UTF-8">
<title>Precious Flower - Member Join</title>
<script
...
<body>
   ...
   <div class="content_area">
      <h2>일반 회원 가입</h2>
      <form class="validation-form" name="m_joinFrm" action="./memInsert" method="post" onsubmit="return check()" novalidate>
         <table class="m_join">
            <tr>
               <td id="category">아이디</td>
               <td>
                  <input type="text" id="mid" name="m_id" autofocus required> 
                  <input type="button" class="btn2" value="아이디 중복확인" onclick="midcheck()">
            ...
            <tr>
               ...
               <td>
                  <input type="password" id="mpassworConfirm" required>
            ...
            <tr>
               ...
               <td>
                  <input type="date" id="mbirth" name="m_birth" required>
            ...
            <tr>
               ...
               <td>
                  <input type="text" id="mphone" name="m_phone" placeholder="010-xxxx-xxxx" required>
            ...
            <tr>
               ...
               <td>
                  <input type="email" id="memail" name="m_email" placeholder="you@example.com" required>
                  <input type="button" class="btn2" value="인증메일 받기" onclick="memailCheck()">
                  <div class="invalid-feedback">이메일을 입력해주세요.</div>
                  <input type="text" class="form-control" id="mauth" name="m_auth" placeholder="인증번호 입력" required>
            ...
            <tr>
               ...
               <td>
                  <input type="text" id="postcode" name="m_addr1" required>
            ...
            <tr>
               ...
               <td>
                  <input type="text" id="address" name="m_addr2">
               </td>
            </tr>
            <tr>
               <td id="category">상세주소</td>
               <td>
                  <input type="text" id="extraAddress" name="m_addr3" placeholder="상세주소를 입력해주세요.">
               </td>
            </tr>
         </table>
...
function memailCheck() {
   var memberEmail = $("#memail").val();
   
   $.ajax({
      type : "GET",
      url: "memailCheck?memberEmail=" + memberEmail,
